/* === ARQUIVO app.js (CORREÇÃO DE ESCOPO E TIMING) === */

// --- VARIÁVEIS GLOBAIS DO APP ---
// Movidas para o topo, fora do DOMContentLoaded
...
// Esta verificação agora é executada imediatamente
if (typeof moduleContent === 'undefined' || typeof moduleCategories === 'undefined' || typeof questionSources === 'undefined') {
    ...
    // Interrompe a execução se os arquivos principais faltarem
    throw new Error("Dependências de dados ausentes.");
}
...
function updateBreadcrumbs(moduleTitle = 'Início') {
    ...
    // Adiciona o listener aqui, pois o elemento é recriado
...
// (Função setupPrintWatermarkContent foi removida daqui e fundida em onLoginSuccess)
...
// A chamada init() é movida para o final, garantindo que todas as funções 
// acima sejam definidas antes de serem chamadas.
init();


// ===== HEADER SCROLL EFFECT =====
// Este listener separado está correto
